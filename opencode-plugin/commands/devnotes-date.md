...
1. Load and use the `sessions-discovery` skill and run `uv run devnotes list-sessions $1 --exclude clients` unless the user explicitly asks to include client work. If `$2` is provided, add `--match $2` to narrow scope.
